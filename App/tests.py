...
class TestViewsHome(TestCase):
    def setUp(self) -> None:
        ...
        self.usuario_de_prueba = self.client.post(
            "https://redsocialxd.herokuapp.com/RegistrarUsuario",
            self.data_usuario_de_prueba,
        )
    ...
    def test_login(self):
        ...
        response = self.client.post(
            "https://redsocialxd.herokuapp.com/accounts/login/?next=/",
            self.data_usuario_de_prueba,
        )
    ...
    def test_crear_posts(self):
        ...
        response = self.client.post(
            "https://redsocialxd.herokuapp.com/Inicio", self.data_usuario_de_prueba
        )
